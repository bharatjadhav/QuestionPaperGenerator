  ...
  @ $content = mysqli_real_escape_string($conn, $content);
   // }
    ...
    $branch= $row["branch"];
     ...
     @ $sql="INSERT INTO `question` (`id`, `question`, `marks`, `difficultyofquestion`, `chapter`, `subject`, `semester`, `branch` ,`upload_img`) VALUES (NULL, '$question', '$marks', '$difficultyofquestion', '$chapter', '$subject', '$semester', '$branch', '$content') ";
...
<h1> ALL question </h1>
 ...
 <?php 
     ...
     echo "</center><br><br>";
            $sql ="SELECT * FROM `question` WHERE `$category` LIKE  '%$txtsearch%' "; 
...
echo" <tr> 
  ...
  echo"    </tr>  
            ...
            echo "</center><br><br>";
            $sql ="SELECT * FROM `question` ORDER BY `question`.`id` DESC  LIMIT 100 "; 
            $result1 = mysqli_query($conn, $sql);
 echo "<table style='width:100%;  border: 1px solid black;'><tr '>         
 <th>question id</th>
            <th>question</th>
